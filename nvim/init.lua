...
autocmd('LspAttach', {
    ...
    callback = function(e)
        ...
        vim.keymap.set("n", "gD", function() vim.lsp.buf.definition() end, { buffer = e.buf, desc = 'Go to Declaration'})
        vim.keymap.set("n", "gi", function() vim.lsp.buf.definition() end, { buffer = e.buf , desc = 'Go to Implementation'})
