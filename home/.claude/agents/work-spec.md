...
- `.workflows/*/specs/` — index and handoff prompts
- `docs/feature/*/` — architecture doc, spec files, contract docs
...
5. Update .workflows/<name>/specs/index.md with dependency-ordered list
