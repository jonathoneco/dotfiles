...
2. **Validate harness health**: Run quick consistency checks before making changes. Report issues but don't block on them unless they're relevant to the requested improvement.
