...
if is_notebook() then
	...
	vim.keymap.set(
		...
		"<localleader>md",
		":MoltenDelete<CR>",
		vim.tbl_extend("force", opts, { desc = "Molten: Delete cell" })
	)
	...
	vim.keymap.set(
		...
		vim.tbl_extend("force", opts, { desc = "Molten: Open in browser" })
	)
	...
	vim.keymap.set(
		...
		"<localleader>mi",
		initialize_molten,
		vim.tbl_extend("force", opts, { desc = "Molten: Initialize" })
	)
	...
	vim.keymap.set(
		...
		"<localleader>ms",
		":MoltenStatus<CR>",
		vim.tbl_extend("force", opts, { desc = "Molten: Show status" })
	)
end
